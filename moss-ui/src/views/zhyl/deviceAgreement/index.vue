<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="deviceAgreementList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="协议名称" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible"
                       prop="reportName"/>
      <el-table-column label="协议内容" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible"
                       prop="reportContent"/>
...
import {
  ...
  delDeviceAgreement,
  addDeviceAgreement,
  updateDeviceAgreement
} from "@/api/zhyl/deviceAgreement";
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {key: 2, label: '协议内容', visible: false},
