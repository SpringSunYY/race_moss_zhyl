  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="deviceSosAlarmDisposeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="长者" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible"
                       prop="userInfoName"/>
      <el-table-column label="预警" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible"
                       prop="dataId"/>
      ...
      <el-table-column label="处理描述" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible"
                       prop="disposeDescribe"/>
      <el-table-column label="处理地址" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible"
                       prop="addressId"/>
      <el-table-column label="详细地址" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible"
                       prop="addressDetail"/>
      <el-table-column label="处理人" :show-overflow-tooltip="true" align="center" v-if="columns[7].visible"
                       prop="userName"/>
...
<script>
import {
  listDeviceSosAlarmDispose,
  getDeviceSosAlarmDispose,
  delDeviceSosAlarmDispose,
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {key: 6, label: '详细地址', visible: false},
