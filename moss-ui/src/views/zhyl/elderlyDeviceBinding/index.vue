  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="elderlyDeviceBindingList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="bindingId" />
        ...
        <el-table-column label="设备" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="deviceId" />
        <el-table-column label="设备IMEI号" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="deviceImei" />
...
<script>
import { listElderlyDeviceBinding, getElderlyDeviceBinding, delElderlyDeviceBinding, addElderlyDeviceBinding, updateElderlyDeviceBinding } from "@/api/zhyl/elderlyDeviceBinding";
